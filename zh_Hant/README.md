...
__v9.4.0 @ 2026-08-24__
  ...
  - 更新了記錄編輯頁面中的標籤選擇列表。
  - 更新了通過“快捷鍵小組件”添加記錄時編輯頁面的佈局。
  
---

__v9.3.0 @ 2026-08-19__
  
  - 記錄時間軸搜索：支持限定詞（value:、note:、tag:）以進行更精確的篩選。
    * i. 小提示：您可以在開頭輸入冒號（:）以顯示可用限定詞。
    * ii. 使用 value: 以過濾金額（如 value:>=100、value:=100 或 value:100）。
    * iii. 若要將搜索字段限定為備注，則在搜索詞前加上“note:”（如 note:abc）。
  
---

__v9.2.0 @ 2026-08-03__
  
  - 優化了報表匯出頁面：增加標籤過濾功能，並支援自動儲存檔案設定偏好以便下次使用。
  - 更新了匯出的 PDF 報表：移除 ID 欄位以提升可讀性。
...
__v9.1.3 @ 2026-07-27__
  ...
  - 更新了報表過濾頁面。
  - 記錄時間線新增「前往...」快捷捲動功能，可直達頂部或目前選取項。
  - 自動鎖定功能：從 Premium 移回至基礎計劃。
  - 修復問題：批處理相關頁面的部分中文本地化失效。
...
__v9.0.1 @ 2026-07-19__
  ...
  - 重構並優化了資料庫存儲與數據同步。
  - 優化了柱狀圖和折線圖報表，新增數據分析指標。
  - 移除了客製化主題概念。
  - 改進並更新了若干設定頁面。
  - 將最低支持版本從 iOS 16.0 提升至 iOS 16.5。
...
__v8.1.1 @ 2026-02-08__
  ...
  - 更新鍵盤交互：在捲動時可互動式地收起鍵盤。
  
---

__v8.0.1 @ 2026-01-07__
  
  - 將最低支持的 iOS 版本從 15.5 提升至 16.0。
  - 微調一些界面元素。
