...
__v9.4.0 @ 2026-08-24__
  ...
  - 更新了记录编辑页面中的标签选择列表。
  - 更新了通过“快捷键小组件”添加记录时编辑页面的布局。
  
---

__v9.3.0 @ 2026-08-19__
  
  - 记录时间轴搜索：支持限定词（value:、note:、tag:）以进行更精确的筛选。
    * i. 小提示：您可以在开头输入冒号（:）以显示可用限定词。
    * ii. 使用 value: 以过滤金额（如 value:>=100、value:=100 或 value:100）。
    * iii. 若要将搜索字段限定为备注，则在搜索词前加上“note:”（如 note:abc）。
  
---

__v9.2.0 @ 2026-08-03__
  
  - 优化了报表导出页面：增加标签过滤功能，并自动保存文件配置以便下次使用。
  - 更新了导出的 PDF 报表：移除 ID 列以提升可读性。
...
__v9.1.3 @ 2026-07-27__
  ...
  - 更新了报表过滤页面。
  - 记录时间线新增“前往...”快捷滚动功能，可直达顶部或当前所选项。
  - 自动锁定功能：从 Premium 移回至基础计划。
  - 修复问题：批处理相关页面的部分中文本地化失效。
...
__v9.0.1 @ 2026-07-19__
  ...
  - 重构并优化了数据库存储和数据同步。
  - 优化了柱状图和折线图报表，新增数据分析指标。
  - 移除了自定义主题概念。
  - 改进并更新了若干设置页面。
  - 将最低支持版本从 iOS 16.0 提升至 iOS 16.5。
...
__v8.1.1 @ 2026-02-08__
  ...
  - 更新键盘交互：在滚动时可交互式地收起键盘。
  
---

__v8.0.1 @ 2026-01-07__
  
  - 将最低支持的 iOS 版本从 15.5 提升至 16.0。
  - 微调一些界面元素。
...
__v7.13.1 @ 2025-07-15__
  ...
  - 终止了通过观看奖励视频的 Premium 试用计划。
  
---

__v7.12.0 @ 2025-06-21__
  
  - 记录时间轴：调整搜索栏（iPhone 版）；
  - 记录时间轴搜索：选择任一记录后，将自动收起键盘。
  
---

__v7.11.0 @ 2025-04-10__
  
  - 同步进程页面：更新了切换自动同步时的确认对话框。
  
---

__v7.10.0 @ 2025-02-25__
  
  - 记录时间轴：修复 iOS 18 中备注的显示问题。
  
---

__v7.9.0 @ 2024-07-01__
  
  - 账户详情页：提供“显示记录”以前往记录时间线。
...
__v7.8.0 @ 2024-03-19__
  ...
  - 生成已结束事件的副本后，默认设为启用状态；
  - 更新货币汇率服务的演示 API 密钥；
  - 记录单位编辑页面：获取所选单位的最新值后，更新“当前汇率”的默认值。
